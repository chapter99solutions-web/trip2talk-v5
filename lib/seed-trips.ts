...
export const SEED_TRIPS: Omit<TripRow, 'id' | 'created_at'>[] = [
  {
    ...
    description: 'Mini aurora hunt, Bruny Island, and Hobart highlights.',
    duration: '3D2N',
    season: 'All Year',
  },
  {
    ...
    description: 'Great Ocean Road, Pink Lake, and Melbourne cityscapes.',
    duration: '4D3N',
    season: 'All Year',
  },
  {
    ...
    description: 'Uluru sunrise, Field of Light, and Kata Tjuta.',
    duration: '4D3N',
    season: 'All Year',
  },
  {
    ...
    description: 'Lake Tekapo, Milford Sound, Wanaka, and Mt Cook.',
    duration: '6D5N',
    season: 'Spring',
  },
  {
    ...
    description: 'Launceston to Hobart summer highlands route.',
    duration: '4D3N',
    season: 'Winter',
  },
  {
    ...
    description: 'Coastal cliffs and sea bridges south of Sydney.',
    duration: '1DAY',
    season: 'All Year',
  },
  {
    ...
    description: 'Golden canola fields and capital region landscapes.',
    duration: '2D1N',
    season: 'All Year',
  },
  {
    ...
    description: 'Iconic harbour and urban photo walk.',
    duration: '1DAY',
    season: 'All Year',
  },
];
