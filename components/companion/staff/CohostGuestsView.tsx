...
export default function CohostGuestsView() {
  ...
  const consentByRef = useMemo(
    ...
    () => Object.fromEntries(consents.map((c) => [c.booking_ref.toUpperCase(), c])),
  ...
  function consentOk(b: ExtendedBookingRow) {
    if (consentByRef[b.booking_ref.toUpperCase()]) return true;
    return isCompanionConsentComplete(b.booking_ref);
  }



  function rulesOk(b: ExtendedBookingRow) {

    return Boolean(consentByRef[b.booking_ref.toUpperCase()]?.consent_rules);

  }



  function rulesAckAt(b: ExtendedBookingRow) {

    return consentByRef[b.booking_ref.toUpperCase()]?.rules_acknowledged_at ?? null;
  ...
  return (
    ...
    <div>
      ...
      <div className="px-4 space-y-4 pb-6">
        ...
        {selected && (
          ...
          <div className="rounded-2xl bg-companion-accent text-companion-dark p-4 text-sm">
              ...
              {rulesOk(selected) ? (
                ...
                <span className="text-green-900 font-medium">
                  ...
                  {rulesAckAt(selected)
                    ...
                    ? ` — ${formatThaiDateTime(rulesAckAt(selected))}`
                ...
                <span className="text-red-800 font-medium">✗ ยังไม่ยืนยัน</span>
            ...
            <p className="mt-1">
              ...
              Consent Step 3: {consentOk(selected) ? '✓' : '✗'}
        ...
        <div className="flex gap-3 text-[10px] text-white/50 px-1">

          <span>consent = Step 3</span>

          <span>กฎ = หน้ากฎความปลอดภัย</span>
                ...
                >
                  ...
                  <div className="flex justify-between items-start gap-2">
                    ...
                    <div className="flex gap-2 shrink-0 text-xs">
                      ...
                      <span className={rulesOk(b) ? 'text-green-400' : 'text-red-400'}>
